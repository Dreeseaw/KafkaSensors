...
conf = {'bootstrap.servers': '{}:{}'.format(args.kafka_host, args.kafka_port), 'group.id': 'numina', 'enable.auto.commit': False}
...
# from docs.confluent.io/clients-confluent-kafka-python/current/overview.html#basic-poll-loop
...
if __name__=="__main__":
    basic_consume_loop(consumer, ["movements"])
